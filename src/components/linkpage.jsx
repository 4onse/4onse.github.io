        ...
        <div className='container' >
          ...
          <div className='paragraph'>
            <Table striped bordered condensed hover>
              <tbody>
                <tr style={{cursor: "pointer"}} onClick={this.handleClick.bind(this, 'https://b2drop.eudat.eu/f/2803196')}>
                ...
                <tr style={{cursor: "pointer"}} onClick={this.handleClick.bind(this, 'https://github.com/4onse/')}>
                ...
                <tr style={{cursor: "pointer"}} onClick={this.handleClick.bind(this, 'https://twitter.com/SNSF_4onse')}>
                  <td><strong>Twitter</strong></td>
                  <td>It is used to share news and promote the project activites</td>
                </tr>
                <tr style={{cursor: "pointer"}} onClick={this.handleClick.bind(this, 'https://www.linkedin.com/in/snsf-4onse-366a45130')}>
          ...
          <div className='paragraph'>
            <Table striped bordered condensed hover>
              <tbody>
                <tr style={{cursor: "pointer"}} onClick={this.handleClick.bind(this, 'http://www.r4d.ch/')}>
                  <td><strong>R4D</strong></td>
                  <td>The Swiss Programme for Research on Global Issues for Development (r4d programme)</td>
                </tr>
                <tr style={{cursor: "pointer"}} onClick={this.handleClick.bind(this, 'https://wiki.osgeo.org/wiki/Open_Monitoring_Systems_Working_Group')}>
