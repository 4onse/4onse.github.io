          ...
          <Table striped bordered condensed hover>
            <tbody>
              ...
              <tr style={{cursor: "pointer"}} >
                ...
                <td>April 2019</td>
                <td><a href={process.env.PUBLIC_URL + "/pdf/Newsletter_3.pdf"} target='_blank'><img role='presentation' height='25' src={linkIcon}></img></a></td>
              </tr>
              <tr style={{cursor: "pointer"}} >
                <td><strong>#4</strong></td>
                <td>August 2019</td>
                <td><a href={process.env.PUBLIC_URL + "/pdf/Newsletter_4.pdf"} target='_blank'><img role='presentation' height='25' src={linkIcon}></img></a></td>
              </tr>
